...
pub struct RvaBundle {
    ...
    pub chr_ins_vmt: u32,
    pub chr_set_vmt: u32,
    pub core_res_heap_allocator: u32,
    ...
    pub csgem_slot_table_vmt: u32,
    pub csgem_slot_vmt: u32,
    ...
    pub debug_heap_allocator: u32,
    pub dl_back_allocator: u32,
    ...
    pub game_man: u32,
    pub gfx_graphics_private_a_heap_allocator: u32,
    pub gfx_graphics_private_b_heap_allocator: u32,
    pub gfx_graphics_private_mix_heap_allocator: u32,
    pub gfx_heap_allocator: u32,
    pub gfx_system_shared_heap_allocator: u32,
    pub gfx_temp_heap_allocator: u32,
    pub global_hinstance: u32,
    pub havok_heap_allocator: u32,
    pub ichr_finder_vmt: u32,
    pub ingame_heap_allocator: u32,
    pub initialize_spawn_geometry_request: u32,
    pub keyboard_device_vmt: u32,
    pub lua_heap_allocator: u32,
    pub main_heap_allocator: u32,
    pub menu_heap_allocator: u32,
    pub mo_wwise_heap_allocator: u32,
    pub mo_wwise_isoration_heap_allocator: u32,
    pub mo_wwise_mo_only_heap_allocator: u32,
    ...
    pub network_heap_allocator: u32,
