...
pub struct CSEventManImp {
    ...
    pub sos_sign: OwnedPtr<CSEventSosSignCtrl, MainHeapAllocator>,
    ...
    pub script: OwnedPtr<CSEventScriptEventInfo, MainHeapAllocator>,
    ...
    pub world_area_time: OwnedPtr<CSEventWorldAreaTimeCtrl, MainHeapAllocator>,
